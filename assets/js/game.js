//ORGINIAL IDEA
//The logic of the game is to have an array of choices and have the image match that word then the 4 choices 
//are displayed in the bottom that come from the another array of choices 
//if the button that was selected matches the image(word array) then the answer is correct
//other choice will have displayed wrong and go to the next one
//Function hides all the information from a page 
$(document).ready(function() {    $('#statext').hide();    $('#image').hide();    $('#distext').hide();    $('#button').hide();});
//When the start button is clicked it starts the game 
$("#startClock").click(function(){    startTimer();    $('#startClock').hide();    $('#statext').show();    $('#image').show();    $('#distext').show();    $('#button').show(); });
// This array holds the words we are going to choose from.//need to add 1 more
var words = ['eleven', 'demogorgon', 'barbara', 'will', 'lucas'];var choices = [['eleven', 'dustin', 'joyce', 'nancy'] , ['lucas', 'dustin', 'joyce', 'nancy'] , ['eleven', 'dustin', 'joyce', 'nancy'] , ['eleven', 'dustin', 'joyce', 'nancy'] , ['eleven', 'dustin', 'joyce', 'nancy'] , ['eleven', 'dustin', 'joyce', 'nancy']]
...
var rand = parseInt(Math.random() * words.length);var word = words[rand];
